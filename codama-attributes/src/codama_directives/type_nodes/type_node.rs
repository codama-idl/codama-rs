...
use codama_nodes::{
    ...
    EnumVariantTypeNode, FixedSizeTypeNode, MapTypeNode, NumberTypeNode, OptionTypeNode,
    PublicKeyTypeNode, RegisteredTypeNode, RemainderOptionTypeNode, SetTypeNode,
