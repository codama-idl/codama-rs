...
/**
 * `@codama-internal/rust-spec-generators` is a private build-time tool,
 * never published to npm and never imported by other workspace crates
 * at runtime. We only need a single Node ESM build that the `generate`
