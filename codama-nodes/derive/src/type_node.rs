...
pub fn expand_attribute_type_node(input: &syn::DeriveInput) -> syn::Result<TokenStream> {
...
pub fn expand_derive_type_node(input: &syn::DeriveInput) -> syn::Result<TokenStream> {
    as_derive_struct(&input)?;
